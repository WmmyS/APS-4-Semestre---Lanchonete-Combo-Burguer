   ...
   <%
    ...
    <script>
        ...
        function valida(){
            ...
            else if(document.getElementById("senhaTxt").value === ""){
                alert("Campo senha está vazio!");
                document.getElementById("senhaTxt").focus();
            } 
            else if(document.getElementById("confirmSenhaTxt").value === ""){
                alert("Campo confirma senha está vazio!");
                document.getElementById("confirmSenhaTxt").focus();
            }   
            else if(document.getElementById("confirmSenhaTxt").value !== document.getElementById("senhaTxt").value){
    ...
    <div id="containerBox">
        ...
        <div id="app">
            ...
            <ul>
                ...
                <li><a  href="index.jsp" >Voltar ao Início</a></li>                
                ...
                <div>
                    ...
                    <div style="padding-top: 77px;" id="quadro">
                        ...
                        <div style="    display: block;" id="telaCadastro"  >
                            <form action="ServletCliente" class="inputCadastro" method="POST" id="formCadastro">
                                   ...
                                   <div class="confirmCad">
                                       ...
                                       <div>
                                           ...
                                           <input type="password" id="senhaTxt" name="senhaTxt">
                                       </div>
                                       <div>
                                           <label for="confirmSenhaTxt">Confirme sua senha</label>
                                           <input type="password" id="confirmSenhaTxt" name="confirmSenhaTxt">
                                       </div>
                                   </div>
                                   <div class="espacoBotoes">
                                       <button type="button" class="botao" onclick="valida()">Cadastrar</button>
