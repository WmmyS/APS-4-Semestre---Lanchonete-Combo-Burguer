                    ...
                    <div id="quadro">
                        ...
                        <div id="sistema"  >
                             ...
                             <%
                                 ...
                                 pedidos = daoP.buscapedidoIDcliente(Integer.parseInt(session.getAttribute("id").toString()));
                                 //out.print(session.getAttribute("id").toString());
                                for(Pedidos p: pedidos){
                                    produtos = daoP.buscaDesc(p.getIdpedido());
                                    int qtde = daoP.buscaQtde(p.getIdpedido());
                                     ...
                                     <div style="    background: #fff; color: #000; padding: 10px; margin: 10px;">
                                        ...
                                        <p style="text-align: left;
                                            ...
                                            <% out.print("Pedido n� "+p.getIdpedido()); %></p>
                                        ...
                                        <p style="text-align: right;
                                                    ...
                                                    display: inline-block;
                                                    width: 20%;">
                                            <% out.print(df.format(p.getDatapedido())); %></p>
