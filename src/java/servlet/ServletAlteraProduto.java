 ...
 * @author lucas
 */
@WebServlet(name = "ServletAlteraProduto", urlPatterns = {"/ServletAlteraProduto"})
public class ServletAlteraProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        produtos.setIdproduto(Integer.parseInt(request.getParameter("codP")));
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletAlteraProduto</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServletAlteraProduto at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
